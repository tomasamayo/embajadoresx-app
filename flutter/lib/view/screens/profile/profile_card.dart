...
class ProfilePageProfile extends StatelessWidget {
                    ...
                    children: [
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              Get.put(LoginController(preferences: controller.preferences)).setData(
                                firstName,
                                lastName,
                                email,
                                phone,
                              ...
                              final avatar = controller.loginModel?.data?.profileAvatar ?? "";
                      ...
                      Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              radius: 50,
                              backgroundImage: NetworkImage(controller.loginModel?.data?.profileAvatar ?? ""),
                      ...
                      Obx(() => Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              "${controller.loginModel?.data?.firstname ?? ''} ${controller.loginModel?.data?.lastname ?? ''}",
                        ...
                        child: Column(
                          children: [
                            _buildProfileRow(
                              ...
                              value: "${model.data?.firstname ?? ''} ${model.data?.lastname ?? ''}",
                            ),
                            ...
                            _buildProfileRow(
                              ...
                              label: "TELÉFONO",
                              value: model.data?.phoneNumber?.isNotEmpty == true
                            ...
                            _buildPlanRow(
                              ...
                              value: (controller.dashboardData?.data.userPlan.planName != null && controller.dashboardData!.data.userPlan.planName.isNotEmpty)
                                  ? controller.dashboardData!.data.userPlan.planName
                                  : (controller.loginModel?.data?.planName ?? "Cargando..."),
                              isActive: model.data?.userStatus?.toLowerCase() == 'ok',
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Icon(
                                controller.isVendorMode.value ? Icons.storefront : Icons.business_center, 
                                color: controller.isVendorMode.value ? const Color(0xFF00FF88) : Colors.grey[400], 
                                size: 22
                              ),
                            ),
                            ...
                            Switch.adaptive(
                              ...
                              onChanged: (val) => controller.toggleVendorMode(),
                            ),
                          ],
                        ),
                      )),
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          final userId = dashboardController.loginModel?.data?.userId ?? 'default'; 
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF1E1E1E),
                            borderRadius: BorderRadius.circular(25),
                            border: Border.all(color: const Color(0xFF06FD71).withOpacity(0.2)),
                          ),
                          child: Row(
                            children: [
                              Container(
                                padding: const EdgeInsets.all(10),
                                decoration: BoxDecoration(
                                  color: const Color(0xFF06FD71).withOpacity(0.1),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: const Icon(Icons.help_outline, color: Color(0xFF06FD71), size: 20),
                              ),
                              const SizedBox(width: 15),
                              const Expanded(
                                child: Column(
  ...
  Widget _buildProfileRow({required IconData icon, required String label, required String value}) {
    return Row(
  ...
  Widget _buildPlanRow({required IconData icon, required String label, required String value, required bool isActive}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Container(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: isActive ? AppColor.appPrimary.withOpacity(0.2) : Colors.red.withOpacity(0.2),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
